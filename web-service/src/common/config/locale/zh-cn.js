export default {
    ...
    validate_req_params_failed: "数据有误，请修改正确后重新提交！",
    validate_captcha_failed: "验证码验证失败",
    identity_existed: "账号已经存在！",
    identity_verified_failed: "账号或者密码失败！",

    email_title_captcha: "XXX网站认证码",
    email_sender_opt: "XXX运营团队"
}